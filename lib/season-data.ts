...
export const season8: SeasonDataset = {
  ...
  contestants: [
    ...
    contestant("s8-kc", "KC Chandler", "KC", "man", 3, 1, "dumped", 40),
    contestant("s8-kenzie", "Kenzie Annis", "Kenzie", "woman", 4, 1, "dumped", 40),
    ...
    contestant("s8-corbin", "Corbin Mims", "Corbin", "man", 12, 4, "dumped", 40),
    ...
    contestant("s8-parmida", "Parmida", "Parmida", "woman", 18, 20, "dumped", 40),
    contestant("s8-sydney", "Sydney Eugene", "Sydney", "woman", 19, 20, "dumped", 24),
    contestant("s8-titi", "Titi", "Titi", "woman", 20, 20, "dumped", 40),
    ...
    contestant("s8-dylan", "Dylan Wrona", "Dylan", "man", 25, 24, "dumped", 40),
