...
export const season8: SeasonDataset = {
  ...
  contestants: [
    ...
    contestant("s8-beatriz", "Beatriz", "Beatriz", "woman", 1, 1, "dumped", 9),
    contestant("s8-bryce", "Bryce Dettloff", "Bryce", "man", 2),
    contestant("s8-kc", "KC Chandler", "KC", "man", 3),
    contestant("s8-kenzie", "Kenzie Annis", "Kenzie", "woman", 4),
    contestant("s8-melanie", "Melanie Moreno", "Melanie", "woman", 5),
    contestant("s8-sean", "Sean", "Sean", "man", 6, 1, "dumped", 5),
    contestant("s8-sincere", "Sincere Rhea", "Sincere", "man", 7),
    contestant("s8-trinity", "Trinity Tatum", "Trinity", "woman", 8),
    contestant("s8-zach", "Zach Georgiou", "Zach", "man", 9),
    contestant("s8-gabriel", "Gabriel", "Gabriel", "man", 10, 2, "dumped", 14),
    contestant("s8-kayda", "Kayda Bosse", "Kayda", "woman", 11, 2),
    contestant("s8-corbin", "Corbin Mims", "Corbin", "man", 12, 4),
    contestant("s8-caleb", "Caleb McDaniel", "Caleb", "man", 13, 6),
    contestant("s8-jen", "Jen Terry", "Jen", "woman", 14, 6),
    contestant("s8-sol", "Sol", "Sol", "woman", 15, 6, "dumped", 14),
    contestant("s8-amora", "Amora Cachee", "Amora", "woman", 16, 20),
    contestant("s8-jaiden", "Jaiden Bacciocco", "Jaiden", "woman", 17, 20),
    contestant("s8-parmida", "Parmida", "Parmida", "woman", 18, 20),
    contestant("s8-sydney", "Sydney Eugene", "Sydney", "woman", 19, 20),
    contestant("s8-titi", "Titi", "Titi", "woman", 20, 20),
    contestant("s8-carl", "Carl Lee Schmidt", "Carl", "man", 21, 24),
    contestant("s8-chandlar", "Chandlar Wilson", "Chandlar", "man", 22, 24),
    contestant("s8-chay", "Chay Nehra", "Chay", "man", 23, 24),
    contestant("s8-corey", "Corey Sawyer Jr.", "Corey", "man", 24, 24),
    contestant("s8-dylan", "Dylan Wrona", "Dylan", "man", 25, 24),
    contestant("s8-gal", "Gal Tshnieder", "Gal", "man", 26, 24),
    contestant("s8-keyon", "Keyon Harry", "Keyon", "man", 27, 24),
    contestant("s8-kyle", "Kyle Greene", "Kyle", "man", 28, 24),
    contestant("s8-ronnie", "Ronnie Gunter", "Ronnie", "man", 29, 24),
    contestant("s8-ryan", "Ryan Ten Hulscher", "Ryan", "man", 30, 24),
    contestant("s8-tino", "Tino Ellis", "Tino", "man", 31, 24),
    contestant("s8-trae", "Trae Taylor", "Trae", "man", 32, 24)
  ],
  series: []
};
