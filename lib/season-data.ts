...
export const season8: SeasonDataset = {
  ...
  contestants: [
    ...
    contestant("s8-sydney", "Sydney Eugene", "Sydney", "woman", 19, 20, "dumped", 24),
    ...
    contestant("s8-dylan", "Dylan Wrona", "Dylan", "man", 25, 24, "dumped", 24),
    contestant("s8-gal", "Gal Tshnieder", "Gal", "man", 26, 24, "dumped", 24),
